...
def process_dagger_ppo(args, env, cfg, cfg_train, log_dir, wandb_writer):
    ...
    DAGGER_PPO = DAGGER_PPO(vec_env=env,
              ...
              cfg = cfg, cfg_algo = cfg_train, wandb_writer = wandb_writer, 
...
def process_pregrasp_ppo(args, env, cfg, cfg_train, logdir, wandb_writer):
...
def process_pregrasp_ppo_pn(args, env, cfg, cfg_train, logdir, wandb_writer):
    from algorithms.pregrasp_ppo import PREGRASP_PPO, ActorCriticPC
