...
class DAGGER_PPO(PREGRASP_PPO):
    ...
    def load_expert(self, path, demo_path = None):
        ...
        if self.model_cfg["use_bc_pretrain"] and demo_path is not None:
            ...
            with torch.no_grad() :
                for r in range(self.eval_round) :
                    ...
                    for i in range(self.max_episode_length) :
                        ...
                        # os.makedirs("/scratch/genghaoran/haoran/RL-Pose/PoseOrientedGym/video/viewer", exist_ok= True)
                        # import pdb
                        # pdb.set_trace()
                        # self.vec_env.task.gym.write_viewer_image_to_file(self.vec_env.task.viewer, "/scratch/genghaoran/haoran/RL-Pose/PoseOrientedGym/video/viewer/{}.png".format(s))
